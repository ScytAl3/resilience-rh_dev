 ...
 */
final class Version20201027150759 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE __temp__testimonials');
        $this->addSql('CREATE INDEX IDX_383115791C0BE183 ON testimonials (solution_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__trainings AS SELECT id, title, human_resources, description, public, pedagogie, prerequis, evaluation, lieu, duree, langue, intervenant, contact, pdf_filename, created_at, updated_at FROM trainings');
        $this->addSql('DROP TABLE trainings');
        $this->addSql('CREATE TABLE trainings (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) NOT NULL, human_resources BOOLEAN DEFAULT \'1\' NOT NULL, description CLOB NOT NULL, public CLOB NOT NULL, pedagogie CLOB NOT NULL, prerequis CLOB DEFAULT \'Aucun.\' NOT NULL, evaluation CLOB NOT NULL, lieu CLOB NOT NULL, duree CLOB NOT NULL, langue VARCHAR(255) NOT NULL, intervenant CLOB NOT NULL, contact CLOB NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, updated_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, pdf_filename VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO trainings (id, title, human_resources, description, public, pedagogie, prerequis, evaluation, lieu, duree, langue, intervenant, contact, pdf_filename, created_at, updated_at) SELECT id, title, human_resources, description, public, pedagogie, prerequis, evaluation, lieu, duree, langue, intervenant, contact, pdf_filename, created_at, updated_at FROM __temp__trainings');
        $this->addSql('DROP TABLE __temp__trainings');
    }
}
